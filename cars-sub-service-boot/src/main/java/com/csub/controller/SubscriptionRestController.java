...
public class SubscriptionRestController {
    ...
    @PostMapping
    public ResponseEntity<JSONInfo> addCar(@RequestBody @Valid SubscriptionRequestDTO subscription) {
    ...
    public ResponseEntity<JSONInfo> updateCar(@RequestBody SubscriptionRequestDTO subscription, @PathVariable long id) {
